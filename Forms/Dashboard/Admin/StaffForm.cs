    ...
    public partial class StaffForm : Form
    {
        ...
        private void Add_btn_Click(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (sqlQueryStatus)
                {
                    MessageBox.Show("Персонал успешно добавлен", "Успех", default, MessageBoxIcon.Information);
        ...
        private void Add_btn_Click_1(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (sqlQueryStatus)
                {
                    MessageBox.Show("Участник успешно добавлен", "Успех", default, MessageBoxIcon.Information);
                    LoadStaffData(); // REFRESH DATA GRID VIEW
                    ResetInputs();
                }
                else
        ...
        private void Update_btn_Click_1(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (sqlQueryStatus)
                {
                    MessageBox.Show("Участник успешно обновлен", "Успех", default, MessageBoxIcon.Information);
                    LoadStaffData(); // REFRESH DATA GRID VIEW
                    ResetInputs();
                }
                else
        ...
        private void Delete_btn_Click_1(object sender, EventArgs e)
        {
            if (isMemeberSelected)
            {
                ...
                if (confirmation == DialogResult.Yes)
                {
                    ...
                    if (sqlQueryStatus)
                    {
                        MessageBox.Show("Участник успешно удален", "Успех", default, MessageBoxIcon.Information);
                        LoadStaffData(); // REFRESH DATA GRID VIEW
